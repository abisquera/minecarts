...
<div class="card invoice-card ">
    ...
    <div class="invoice-info mb-4">
        <p class="mb-0 text-end" id="reservationDT"></p>
    </div>
    <div class="invoice-info mb-4 text-center">
      <img id="reservationCodeIMG" alt="">
    </div>
    <div class="invoice-table">
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <h3 id="lotName" class="font-weight-bold"></h4>
          <p id="lotAddress" class="font-weight-bold"></p>
      ...
      <div class="row">
        ...
        <div class="col-md-6 text-center">
          <h5><div id="reservationDateTime"></div> </h5>
          <h5><div id="endDateTime"></div></h5>
          <h5><div id="amountPaid"></div></h5>
      </div>
      </div>
      </div>
  </div>
  ...
  <script>
    PARAMS.init({
      loadActivityInfoURL : "<?=request_url("loadActivityInfo")?>?d=<?=$d?>",
    });
  </script>
</html>