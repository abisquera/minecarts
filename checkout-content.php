...
<div class="card invoice-card shadow">
    ...
    <div class="invoice-info mb-4">
        <p class="mb-0 text-end" id="reservationDT">Due Date: Nov 16, 2021</p>
        <h4 class="mb-1" id="lotName"></h4>
        <h5 id="lotAddress"></h5>
    </div>
    <div class="invoice-table">
    <div class="divider divider-center-icon border-light">
        <i>
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" height=33 width=33 class="align-center"
                width="`1015.000000pt" height="661.000000pt" viewBox="0 0 1015.000000 661.000000"
    ...
    <div>
        ...
        <h5 id="vehicleType"></h5><br>
        <input type="hidden" id="reservationCode">
        <h5>Reservation : <div id="reservationDateTime"></div> </h5><br>
        <h5>Start : <div id="startDateTime"></div> </h5><br>
        <h5>End : <div id="endDateTime"></div> </h5><br>
        <h5>Amount : <div id="price" class="text-success font-weight-bold"></div> </h5><br>
        <div class="divider divider-center-icon border-light"></div>
