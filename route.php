...
<path d="M8 11a3 3 0 1 1 0-6 3 3 0 0 1 0 6zm0 1a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM8 0a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 0zm0 13a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 13zm8-5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2a.5.5 0 0 1 .5.5zM3 8a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2A.5.5 0 0 1 3 8zm10.657-5.657a.5.5 0 0 1 0 .707l-1.414 1.415a.5.5 0 1 1-.707-.708l1.414-1.414a.5.5 0 0 1 .707 0zm-9.193 9.193a.5.5 0 0 1 0 .707L3.05 13.657a.5.5 0 0 1-.707-.707l1.414-1.414a.5.5 0 0 1 .707 0zm9.193 2.121a.5.5 0 0 1-.707 0l-1.414-1.414a.5.5 0 0 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .707zM4.464 4.465a.5.5 0 0 1-.707 0L2.343 3.05a.5.5 0 1 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .708z"/>
          ...
          <div id="map" style="min-height:350px"></div>
            ...
            <div class="row">
                <div class="col text-center">
                    <a class="btn m-1 btn-lg btn-creative btn-danger" id="openMapUrl"><i class="fa fa-google me-2"></i>Google Map</a>
                </div>
            </div>
        </div>
      </div>
      <!-- https://www.google.com/maps/dir/?api=1&origin=40.748817,-73.985428&destination=38.8976763,-77.0365298&travelmode=driving&dir_action=navigate -->
      <div class="pb-3">
      </div>
    </div>
    ...
    <script>
        ...
        function initMap() {
            ...
            var loc = new google.maps.LatLng(13.756896, 121.07 );
            var mapOptions = {
                zoom:14,
                center: loc
            }
            ...
            directionsRenderer.setMap(map);
                ...
                if(navigator.geolocation){
                    ...
                    (position) => {
                        ...
                        map.setCenter(myPos);
                        calcRoute(myPos)
                        getRouteURL(myPos,{ lat  : <?=$_GET["lat"]?>, lng  : <?=$_GET['lng']?>  })
                    },
                    () => {
                    }
                    );
        ...
        function calcRoute(myPos) {
            var request = {
                origin: myPos.lat+","+myPos.lng,
                destination: "<?=$_GET["lat"]?>,<?=$_GET['lng']?>",
        ...
        function getRouteURL(orig,des)
        {
            $.get("<?=request_url("getRouteURL")?>", {orig:orig,des:des},
                function (data, textStatus, jqXHR) {
                    $("#openMapUrl").attr("href",data)
